                        ...
                        <div class="tabbable-panel mt-20">
                            <div class="tabbable-line">
                                ...
                                <ul class="nav nav-pills mb-3 mt-5 justify-content-center" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item pi">
                                        <a class="nav-link" data-toggle="tab" href="#tab_default_6">Offline</span></a>
                                    </li>
                                ...
                                <div class="tab-content">
                                                        ...
                                                        <div class="credit-card-box">
                                                            ...
                                                            <div class="box-body p-0">
                                                                ...
                                                                if (settings()->enable_wallet == 1) {
                                                                    ...
                                                                    $publish_key = $user->publish_key;
                                                                    $currency_code = $user->currency;
                                                                }
                                                                ?>
                                                                <form role="form" action="<?php echo base_url('admin/payment/stripe_payment') ?>" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo html_escape($publish_key); ?>" id="payment-form">
                                    ...
                                    <div class="tab-pane text-center" id="tab_default_6">
                                        <!-- stripe payment -->
                                               ...
                                               <div class="row justify-content-center">
                                                    <div class="box col-md-8 m-auto text-center">
                                                        ...
                                                        <div class="box-header mb-30">
                                                            ...
                                                            <div>
                                                                <p class="text-center"><?php echo trans('offline-payment-instructions') ?>Offline Payment Instructions</p>
                                                                <div class="bg-light p-4 rounded"><p>Enter your bank info to receive offline payments<?php echo settings()->offline_details ?></p></div>
                                                            </div>

                                                            <form enctype="multipart/form-data" action="<?php echo base_url('admin/payment/offline_payment_paitent/'.md5($appointment->id)) ?>" method="post" class="form-horizontal mt-3">
                                                            
                                                                <div class="form-group text-left pt-3 pb-3">    
                                                                    <label for="exampleFormControlFile1">Upload Payment Proof<?php echo trans('upload-payment-proof') ?></label>
