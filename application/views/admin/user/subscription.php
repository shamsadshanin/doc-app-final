              ...
              <div class="box-header">
                ...
                <div class="box-body box-profile py-4">
                  ...
                  <?php else: ?>
                      ...
                      <?php else: ?>
                        <p class="mb-10"><?php echo trans('expired') ?> : <strong><?php echo my_date_show($user->expire_on); ?></strong> 
                      <?php endif ?>
               ...
               <div class="pricing-table purple text-center shadow-lg">
                ...
                <div class="pricing-features mb-40">
                  ...
                  <?php if ($user->package_id == $package->id): ?>
                      <?php if (user()->user_type == 'registered'): ?>
                        <a class="btn btn-primary btn-lg btn-block package_btn" href="javascript:;"> <?php echo trans('your-selected-plan') ?></a>
                      <?php else: ?>
