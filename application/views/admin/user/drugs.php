...
<div class="content-wrapper">
  ...
  <section class="content container">
    ...
    <div class="box list_area">
      ...
      <form method="get" action="<?php echo base_url('admin/drugs') ?>">
        <div class="input-group mb-5 mt-3 p-10">
          <input type="text" name="search" value="<?php if(isset($_GET['search'])){echo html_escape($_GET['search']);} ?>" class="form-control" placeholder="search drugs" aria-label="Recipient's username" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <button class="btn btn-primary drug_search" type="submit"><i class="fa fa-search"></i> <?php echo trans('search') ?></button>
          </div>
        </div>
      </form>
