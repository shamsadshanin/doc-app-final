<div class="content-wrapper">
  ...
  <section class="content container">
      ...
      <div class="box-body">
        <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/advises/add')?>" role="form" novalidate>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" required name="name" value="<?php echo html_escape($advise[0]['name']); ?>" >
          </div>

          <div class="form-group">
            <label><?php echo trans('details') ?></label>
            <textarea id="ckEditor" class="form-control" name="details" rows="6"><?php echo html_escape($advise[0]['details']); ?></textarea>
          </div>

          <input type="hidden" name="id" value="<?php echo html_escape($advise['0']['id']); ?>">
          <!-- csrf token -->
    ...
    <div class="box list_area">
      <div class="box-header with-border">
        <?php if (isset($page_title) && $page_title == "Edit"): ?>
          <h3 class="box-title"><?php echo trans('edit') ?> <a href="<?php echo base_url('admin/advises') ?>" class="pull-right btn btn-light-secondary mt-15 btn-sm"><i class="fa fa-angle-left mt-15"></i> <?php echo trans('back') ?></a></h3>
        <?php else: ?>
          <h3 class="box-title"><?php echo trans('all-advises') ?> </h3>
        <?php endif; ?>
      ...
      <div class="box-body">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive">
            <table class="table table-bordered <?php if(count($adviseses) > 10){echo 'datatable';} ?>" id="dg_table">
                <thead>
                    <tr>
                        <th>#</th>
                ...
                <tbody>
                  <?php $i=1; foreach ($adviseses as $advis): ?>
                    <tr id="row_<?php echo html_escape($advis->id); ?>">
                        
                        <td><?= $i; ?></td>
                        <td><?php echo html_escape($advis->name); ?></td>
