          ...
          <div class="col-md-12">
            ...
            <div class="card list_area">
              <div class="card-header with-border">
                  <h3 class="card-title pt-2"><?php echo ucfirst(trans('completed')) ?> </h3>
                  ...
                  <div class="filter_popup showFilter">
                    ...
                    <form action="<?php echo base_url('admin/referral/completed_payout') ?>" class="sort_form" method="get">
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <tr id="row_<?php echo html_escape($row->id); ?>">
                              ...
                              <td>
                                ...
                                <a data-toggle="modal" href="#payoutModal_<?php echo html_escape($i) ?>" >
                                  <span class="badge badge-info"><i class="fa fa-eye"></i> <?php echo trans('view-details') ?></span>
                                </a>
                              </td>
                              <td>
                              ...
                              <td class="actions">
                                  <div class="btn-groups">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                      <?php if ($row->status == 0): ?>
                                        <a href="<?php echo base_url('admin/referral/payout_complete/'.md5($row->id));?>" class="dropdown-item <?php if($user_balance < $withdraw_amount){echo "hide";} ?>"><i class="fa fa-check-circle"></i><?php echo trans('completed') ?></a>
                                      <?php endif ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header justify-content-between">
        <h5 class="modal-title font-weight-bold"><?php echo trans('payout-method') ?> (<?php echo ucfirst($payout->payout_method) ?>)</h5>
