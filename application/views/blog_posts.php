	...
	<div class="container">
		...
		<div class="row align-items-center justify-content-center">
			<div class="col-lg-10 col-xl-8 text-center">
				...
				<form class="w-sm-90 mx-auto mx-lg-0 rounded-pill pl-4 pr-0 newsletter-form bg-white mb-4" action="<?php echo base_url('blogs') ?>" data-aos="fade-up">
                    <div class="input-group" data-aos="fade-up">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-white text-secondary m-0 px-4" type="submit"><i class="fas fa-search"></i></button>
                        </div>
                    </div>
                </form>
			</div>
