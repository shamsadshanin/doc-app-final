...
class Diagonosis extends Home_Controller {
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url('admin/diagonosis');
        $total_row = $this->admin_model->get_all('diagonosis', $total=1, 0, 0);
        ...
        $data['diagonosises']=$this->admin_model->get_all('diagonosis', $total=0, $config['per_page'], $page * $config['per_page']);
