        ...
        {   
            ...
            if ($this->form_validation->run() === false) {
                ...
                if ($id != '') {
                    ...
                    $msg = 'Your account has been created successfully, now you can login to your account using below access <br> Username:'.$this->input->post('email').' , and Password: '.$this->input->post('password');
