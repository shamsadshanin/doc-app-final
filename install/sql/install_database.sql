...
--
-- Host: localhost:8889
-- Generation Time: May 05, 2025 at 05:07 AM
...
(792, 'admin', 'Email Template Settings', 'email-template-settings', 'Email Template Settings'),
(793, 'admin', 'Overview', 'overview', 'Overview'),
(794, 'admin', 'Upload Banner', 'upload-banner', 'Upload Banner'),
(795, 'admin', 'Template', 'template', 'Template'),
(796, 'admin', 'Select Profile Template', 'select-profile-template', 'Select Profile Template'),
(797, 'admin', 'Do not bold the variable names or brackets.', 'dont-bold-the-variable-names-or-brackets', 'Do not bold the variable names or brackets.'),
(798, 'admin', 'Dosing Schedule', 'dosing-schedule', 'Dosing Schedule'),
(799, 'admin', 'Sender Email', 'sender-email', 'Sender Email');
...
CREATE TABLE `users` (
  ...
  `description` text,
  `custom_js` text,
  `template` int(11) NOT NULL DEFAULT '2',
